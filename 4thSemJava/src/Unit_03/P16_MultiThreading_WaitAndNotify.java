 ...
 * 
 * 
 * wait is method of object class...all the classes in java are generally extended by object class...wait invoke other threads
 * notify method tells wait to resume only one
 * notifyAll method tells wait to resume all
 * */
