...
class ABC{
	...
	void takeInputFromAFileNotFromConsole() throws IOException {
		String path="C:\\Users\\asus\\git\\COREJAVA4\\4thSemJava\\src\\Unit_03\\Input.txt";
	...
	void saveOutputIntoAFile() throws IOException {
		...
		String text ="hey this wud store in output file";
...
void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\asus\\git\\COREJAVA4\\4thSemJava\\src\\Unit_03\\log.txt",true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
