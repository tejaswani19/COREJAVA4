...
- Declare an Array in Java : DataType arrayRefVar[];  OR  DataType[] arrayRefVar;  OR DataType []arrayRefVar;
...
public class P6_Task01_ArraysInJava {
	...
	public static void main(String[] args) {
		...
		int array4[] = {33, 3, 4, 5}; // declaraton, instantiation and initialization
