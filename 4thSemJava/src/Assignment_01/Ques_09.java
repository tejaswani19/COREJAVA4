...
{
	//
	//Illegal modifier for the class rom; only public, abstract & final are permitted
...
class ParentClass{
	...
	public int b = 20;//Can be accessed outside Assignment_01 package within same project
	protected int c = 30;//Can only accessed only within Assignment_01 package
